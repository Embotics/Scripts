...
.DESCRIPTION
 ...
 powershell.exe C:\Scripts\Disable_termiationprotection.ps1 '#{target.remoteId}' '#{target.id}' '#{target.region.name}'
...
#AWS
    $AWSAccesskey = '0000000000000'
    $AwsSecretkey = '0000000000000000000000000000'
